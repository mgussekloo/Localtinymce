...
Nova.booting(function (Vue, router, store) {
  // Vue.component('index-localtinymce', require('./components/IndexField'))
  Vue.component('detail-localtinymce', __webpack_require__(7));
  Vue.component('form-localtinymce', __webpack_require__(10));
});
...
/* harmony default export */ __webpack_exports__["default"] = ({
	...
	methods: {
		images_upload_handler: function images_upload_handler(blobInfo, success, failure) {
			...
			Nova.request().post(this.field.upload_url, formData, { headers: headers }).then(function (response) {
	...
	mounted: function mounted() {
		...
		this.loadingInterval = window.setInterval(function () {
			if (window.tinyMCE && window.tinyMCE.majorVersion == 5) {
				_this.loaded = true;
				window.clearInterval(_this.loadingInterval);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__components_Editor__ = __webpack_require__(13);
/**
 * Copyright (c) 2018-present, Ephox, Inc.
 *
 * This source code is licensed under the Apache 2 license found in the
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__ScriptLoader__ = __webpack_require__(14);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__TinyMCE__ = __webpack_require__(15);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__Utils__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__EditorPropTypes__ = __webpack_require__(17);
/**
 * Copyright (c) 2018-present, Ephox, Inc.
 *
 * This source code is licensed under the Apache 2 license found in the
          ...
          ? _c(
              ...
              [
                _c("editor", {
                  ...
                  attrs: { "api-key": "no-api-key", init: _vm.editorInit },
                  model: {
                    value: _vm.value,
                    callback: function($$v) {
                      _vm.value = $$v
